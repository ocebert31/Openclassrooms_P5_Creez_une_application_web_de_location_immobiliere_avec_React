...
function ContainerLogement(props) {
    ...
    // Vérifiez si props.pictures est défini et s'il est un tableau
    if (!props.pictures || !Array.isArray(props.pictures)) {
    ...
    return (
        <div className='style-image'>
            ...
            <img src={props.pictures[currentImageIndex]} alt="logement" className="main-image"/>
